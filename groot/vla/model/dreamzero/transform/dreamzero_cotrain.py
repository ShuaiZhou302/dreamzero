        ...
        if key == "text":
            ...
            for elem in features:
                ...
                try:
                    ...
                    elif elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.AGX_ALOHA.value]:
                        processed_item = "A multi-view video shows that a robot " + processed_item.lower() + " The video is split into three views: The first view shows the high camera, the second view shows the left wrist camera, and the third view shows the right wrist camera. The robot " + processed_item.lower()
                    else:
                    ...
                    if num_views > 1 and elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.AGIBOT.value]:
                        ...
                        item = "A multi-view video shows that a robot " + str(item).lower() + " The video is split into three views: The first view shows the high camera, the second view shows the left wrist camera, and the third view shows the right wrist camera. The robot " + str(item).lower()
                    else:
                        raise ValueError(f"Embodiment ID {elem['embodiment_id']} not supported.")   
